...
global {
	...
	reflex save_agent_attribute{ //when: cycle = 10 {
		ask people {
			...
			save [name, cycle, location, living_place, working_place, is_susceptible, is_infected, is_immune] to: "/Volumes/DATA/MAS/Data/Agents/Agents_"+ string(cycle) +".csv" type:"csv" rewrite: false;
